...
{var cs=new ChronoSanctum('cs1','T',5);var r=new TimeRift('r1','T',60,50);r.opened=true;cs.addRift(r);var a=new TemporalAnchor('a1','T',70,50);a.anchored=true;cs.addAnchor(a);var f=new AgeForge('f1','T',50,60);f.forged=true;cs.addForge(f);assertEq(cs.getSanctumPower(),415,'415 total');}
