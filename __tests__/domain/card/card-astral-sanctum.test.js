...
{var as=new AstralSanctum('as1','T',5);var b=new StarBeacon('b1','T',60,50);b.active=true;as.addBeacon(b);var r=new CosmicRay('r1','T',70,40);r.emitted=true;as.addRay(r);var c=new NebulaCore('c1','T',50,60);c.ignited=true;as.addCore(c);assertEq(as.getSanctumPower(),620,'620 total');}
